...
# Agent图标和名称映射
AGENT_MAP = {
    "market_data_tool": {"icon": "📊", "name": "市场数据"},
    "technical_analysis_tool": {"icon": "📈", "name": "技术"},
    "fundamentals_analysis_tool": {"icon": "📝", "name": "基本面"},
    "online_sentiment_agent": {"icon": "🔍", "name": "情感"},
    "valuation_analysis_tool": {"icon": "💰", "name": "估值"},
    "bullish_research_agent": {"icon": "🐂", "name": "多方研究"},
    "bearish_research_agent": {"icon": "🐻", "name": "空方研究"},
    "tripartite_judgment_agent": {"icon": "🗣️", "name": "辩论室"},
    "risk_assessment_tool": {"icon": "⚠️", "name": "风险管理"},
    "macro_market_agent": {"icon": "🌍", "name": "针对所选股宏观"},
    "macro_news_agent": {"icon": "📰", "name": "宏观新闻"},
    "summary_synthesis_agent": {"icon": "📂", "name": "投资组合管理"}
}
...
class StructuredTerminalOutput:
    ...
    def _format_agent_section(self, agent_name: str, data: Any) -> List[str]:
        ...
        if isinstance(data, dict):
            # 特殊处理summary_synthesis_agent
            if agent_name == "summary_synthesis_agent":
